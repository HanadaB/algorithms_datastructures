...
protected:
  ...
  */
  ...
  //  ...
   ...
   std::string pattern; //interne Darstellung von Pattern
   int lookupTable[128]; //ASCII Nachschlagtablle für sichere Verschiebungen (shifts)
   size_t patt_leng; //Länge von Pattern
   size_t wil_shift; //Wildcard safe shifts
